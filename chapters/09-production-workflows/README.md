...
Treat a WordPress site as a deployed application, not a collection of files edited directly on a server. Make changes reproducible, measurable, reversible and safe for real users.
